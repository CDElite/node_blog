...
router.post('/post', function (req, res) {
	...
	var post = new Post(currentUser.name, req.body.title, tags,
		req.body.post);
...
router.get('/remove/:id', function (req, res) {
	Post.getUserName(req.params.id, function (err, userName) {
		if (err) {
			req.flash('error', err);
			return res.redirect('back');
		}
...
router.get('/tags/:tag', function (req, res) {
	Post.getFromTag(req.params.tag, function (err, posts) {
		if (err) {
			req.flash('error', err);
			return res.redirect('/');
		}
